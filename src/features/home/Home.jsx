    ...
    <div className="home">
      <header className="hero" role="banner">
        ...
        <div className="container hero__copy">
          <div className="hero__logo-showcase" aria-hidden>
            <img src={peerfundGlobe} alt="" className="hero__logo-large" />
          </div>
          ...
          <section className="container story">
            <div className="card story__card">
              ...
              <p className="text-muted">
                We’ve lived the paycheck-to-paycheck grind. PeerFund connects people to
                people — not to predatory lenders — so help and fair returns stay in the
                community.
              </p>
            </div>
          </section>
          ...
          <div className="features__grid">
            <article className="feature">
              ...
              <p className="feature__desc">
                Tell the community what you need, why, and for how long. No predatory
                fees.
              </p>
            </article>
            ...
            <article className="feature">
              ...
              <p className="feature__desc">
                Users propose terms. You choose the best offer; everything is saved to a
                contract.
              </p>
            </article>
            ...
            <article className="feature">
              ...
              <p className="feature__desc">
                Clear schedules, reminders, and a running history of payments and
                messages.
              </p>
            </article>
          </div>
          ...
          <div className="cta__row">
            <div>
              ...
              <p className="cta__desc">
                Create your account and explore open requests in minutes.
              </p>
            </div>
          ...
          <div className="faq__list">
            <details className="faq__item">
              <summary className="faq__q">
                Do I need to pick a “Borrower” or “Lender” role?
              </summary>
              <p className="faq__a">
                No. There’s just one user type. You can request or offer on any loan.
              </p>
            </details>
            ...
            <details className="faq__item">
              ...
              <p className="faq__a">
                Payments and payouts run through Stripe. You can link a bank, deposit to
                your wallet, and repay on a schedule.
              </p>
            </details>
            ...
            <details className="faq__item">
              ...
              <p className="faq__a">
                Superusers avoid the PeerFund fee. Banking/Stripe processing fees still
                apply.
              </p>
            </details>
          </div>
      ...
      <footer className="home-footer" role="contentinfo">
        <div className="container flex items-center justify-between">
          ...
          <div className="flex items-center gap-10 text-muted">
            <button className="link-ghost" onClick={() => navigate('/terms')}>
              Terms
            </button>
            <button className="link-ghost" onClick={() => navigate('/privacy')}>
              Privacy
            </button>
          </div>
        </div>
